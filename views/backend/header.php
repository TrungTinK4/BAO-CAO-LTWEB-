...
<body class="hold-transition sidebar-mini">
   <div class="wrapper">
      ...
      <a href="../backend/index.html" class="brand-link">
            <img src="../public/dist/img/tt1.png" alt="AdminLTE Logo"
               class="brand-image img-circle elevation-3" style="opacity: .9">
            <span class="brand-text font-weight-center">ADMIN</span>
         </a>
         <div class="sidebar">
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
               <div class="image">
                  <img src="../public/images/user/<?= ($_SESSION['image'])??'image.png'; ?>" class="img-circle-elevation-2" alt="<?= ($_SESSION['image'])??'image.png'; ?>">
               </div>
               <div class="info">
